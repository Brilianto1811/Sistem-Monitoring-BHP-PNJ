            ...
            <div class="card-body">
                <table id="table-utama" class="table table-sm table-striped table-bordered" style="width:100%">
                    <tbody>
                        ...
                        <tr>
                            <td>Referensi -> Kode Permintaan Mahasiswa:</td>
                            <td>
                                @if (!in_array($dataTransaksi->trxfrom, ['', null]))
                                <a href="{{ route('transaksi.permintaan.terima.verifikasi', ['id_trx' => $dataTransaksi->trxfrom]) }}" target="_blank">{{ $dataTrxReqMhs->kode_permintaan }}</a>
                                @endif
                            </td>
                        </tr>
                        <tr>
                            <td>Referensi -> Informasi Permintaan Mahasiswa:</td>
                            <td>{{ $dataTransaksi->trxfrom_ket }}</td>
                        </tr>
                        <tr>
                            <td colspan="2"><hr></td>
                        </tr>
                ...
                <div class="row mt-1">
                    <div class="col-12">
                        <a href="{{ route('transaksi.stok.out.index') }}" class="btn btn-secondary m-1 radius-30 px-5"><i class="bx bx-chevron-left me-1"></i>Kembali</a>
                    </div>
                </div>
                {{-- [END] ACTION FORM --}}
            </div>
