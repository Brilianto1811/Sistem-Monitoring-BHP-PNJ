...
@section('title', 'Halaman Stok In Bahan')
@section('content')
    <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <a href="{{ route('transaksi.stok.in.create') }}" class="btn btn-primary m-1 radius-30 px-5"><i class="bx bx-plus me-1"></i>Form Stok In Bahan</a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">Data Stok In Bahan</h4>
                    </div>
                    <hr/>
                            ...
                            <tbody>
                                @foreach ($dataTransaksi as $nomor => $value)
                                    <tr>
                                        ...
                                        <td>{!! $value->ket !!}</td>
                                        <td>
                                            <a href="{{ route('transaksi.stok.in.detail', ['id_trx' => $value->id_trx]) }}"
