...
@section('title', 'Form Stok In Bahan')
@section('content')
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{ route('transaksi.stok.in.index') }}">Stok In</a>
                </li>
...
<div class="container" id="app">
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form ref="mainForm" method="POST" action="{{ route('transaksi.stok.in.proses-add') }}" @submit.prevent="onSubmitCancel()">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-end">
                            <button class="btn btn-success btn-sm" type="button" @click="addRow()"><i class="bx bx-plus me-1"></i>Tambah Bahan Masuk</button>
                        </div>
                    </div>
                    <div class="row mb-3" v-for="(x, k) in listStok" :key="x">
                        ...
                        <div class="col-6">
                            <label class="form-label">Jumlah Stok In:</label>
                            <input class="form-control form-control-sm" type="number" name="stok[]" :id="'stok'+k" placeholder="Masukkan Jumlah Stok Bahan Masuk (minimal 1) | Contoh: 3, 5, 7" min="1" required>
                        </div>
                        <div class="row mt-3">
                            <hr>
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-8 text-center">
                            <a href="{{ route('transaksi.stok.in.index') }}" class="btn btn-secondary m-1 radius-30 px-5"><i class="bx bx-x me-1"></i>Batal</a>
