    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-1">
                    <div class="col-12">
                        <a href="{{ route('transaksi.stok.in.index') }}" class="btn btn-secondary m-1 radius-30 px-5"><i class="bx bx-chevron-left me-1"></i>Kembali</a>
                    </div>
                </div>
                {{-- [END] ACTION FORM --}}
            </div>
...
<script>
    $('.single-select').select2({
      ...
      q  placeholder: $(this).data('placeholder'),
