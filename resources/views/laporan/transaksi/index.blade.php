...
@section('title', 'Halaman Laporan Transaksi')
@section('content')
    <div class="row">
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    <a href="{{ route('laporan.transaksi.index') }}" name="filter" value="clear"
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">Data Laporan Transaksi Stok In & Out</h4>
                    </div>
                    <hr />
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h4 class="mb-0">Data Laporan Transaksi Pemindahan Barang</h4>
                    </div>
                    <hr />
                    <div class="table-responsive">
