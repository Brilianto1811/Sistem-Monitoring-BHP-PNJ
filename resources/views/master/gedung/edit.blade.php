...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('master.gedung.proses-edit') }}">
                    @csrf
                    <input value="{{ $dataGedung->id_gedung }}" type="hidden" name="oldid" id="oldid">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input value="{{ $dataGedung->kode_gedung }}" class="form-control form-control-sm" type="text" name="kode_gedung" id="kode_gedung" placeholder="Masukkan Kode Gedung | Contoh: GM1, GS2, GE3" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input value="{{ $dataGedung->nama_gedung }}" class="form-control form-control-sm" type="text" name="nama_gedung" id="nama_gedung" placeholder="Masukkan Nama Gedung | Contoh: Gedung Mesin 1, Gedung Sipil 2, Gedung Elektro 3" required>
                        </div>
                    </div>
