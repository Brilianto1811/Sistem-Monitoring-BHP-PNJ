...
<div class="row">
    <div class="col-12">
        <a href="{{ route('master.gedung.create') }}" class="btn btn-primary m-1 radius-30 px-5"><i class="bx bx-plus me-1"></i>Tambah Gedung</a>
    </div>
</div>
<div class="row mt-3">
    <div class="col-12">
                        ...
                        <tbody>
                            @foreach ($dataGedung as $nomor => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('master.gedung.detail', ['id_gedung' => $value['id_gedung']]) }}" class="btn btn-info btn-sm m-1"><i class="bx bx-detail"></i></a>
                                        <a href="{{ route('master.gedung.edit', ['id_gedung' => $value['id_gedung']]) }}" class="btn btn-warning btn-sm m-1"><i class="bx bx-edit"></i></a>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content bg-white">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('master.gedung.proses-delete', ['id_gedung' => $value['id_gedung']]) }}" class="btn btn-danger">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
