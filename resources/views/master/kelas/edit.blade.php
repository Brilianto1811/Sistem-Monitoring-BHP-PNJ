...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('master.kelas.proses-edit') }}">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input value="{{ $dataKelas->kode_kelas }}" class="form-control form-control-sm" type="text" name="kode_kelas" id="kode_kelas" placeholder="Masukkan Kode Kelas | Contoh: KR1, KKS2" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input value="{{ $dataKelas->nama_kelas }}" class="form-control form-control-sm" type="text" name="nama_kelas" id="nama_kelas" placeholder="Masukkan Nama Kelas | Contoh: Reguler 1, Kerjasama 2" required>
                        </div>
                    </div>
