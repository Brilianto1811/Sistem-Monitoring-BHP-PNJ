...
<div class="container">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('master.blok.proses-edit') }}">
                    @csrf
                    <input value="{{ $dataBlok->id_blok }}" type="hidden" name="oldid" id="oldid">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input value="{{ $dataBlok->kode_blok }}" class="form-control form-control-sm" type="text" name="kode_blok" id="kode_blok" placeholder="Masukkan Kode Blok | Contoh: Lt1, Lm2, R3">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <input value="{{ $dataBlok->nama_blok }}" class="form-control form-control-sm" type="text" name="nama_blok" id="nama_blok" placeholder="Masukkan Nama Blok | Contoh: Lantai 1, Lemari 2, Rak 3">
                        </div>
                    </div>
