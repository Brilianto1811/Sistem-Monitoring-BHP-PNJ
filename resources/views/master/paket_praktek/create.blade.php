...
@section('title', 'Form Tambah Paket Praktik')
@section('content')
...
<div class="container" id="app">
    <div class="row">
        <div class="card">
            <div class="card-body">
                <form id="mainForm" ref="mainForm" method="POST" action="{{ route('master.paket-praktek.proses-add') }}" @submit.prevent="onSubmitCancel()">
                    @csrf
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <input class="form-control form-control-sm" type="text" name="kode_praktek" id="kode_praktek" placeholder="Masukkan Kode Praktik | Contoh: PPT1, PBM2" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label">Nama Praktik:</label>
                            <input class="form-control form-control-sm" type="text" name="nama_praktek" id="nama_praktek" placeholder="Masukkan Nama Praktik | Contoh: Perkakas Tangan 1, Bengkel Mekanik 2" required>
                        </div>
                    </div>
                    <div class="row mb-3">
