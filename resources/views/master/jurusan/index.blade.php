...
<div class="row">
    <div class="col-12">
        <a href="{{ route('master.jurusan.create') }}" class="btn btn-primary m-1 radius-30 px-5"><i class="bx bx-plus me-1"></i>Tambah Jurusan</a>
    </div>
</div>
<div class="row mt-3">
    <div class="col-12">
                        ...
                        <tbody>
                            @foreach ($dataJurusan as $nomor => $value)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('master.jurusan.detail', ['id_jurusan' => $value['id_jurusan']]) }}" class="btn btn-info btn-sm m-1"><i class="bx bx-detail"></i></a>
                                        <a href="{{ route('master.jurusan.edit', ['id_jurusan' => $value['id_jurusan']]) }}" class="btn btn-warning btn-sm m-1"><i class="bx bx-edit"></i></a>
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content bg-white">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="{{ route('master.jurusan.proses-delete', ['id_jurusan' => $value['id_jurusan']]) }}" class="btn btn-danger">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
