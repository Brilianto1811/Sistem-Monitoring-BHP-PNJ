...
<div class="row">
    <div class="col-12">
        <a href="{{ route('master.prodi.create') }}" class="btn btn-primary m-1 radius-30 px-5"><i class="bx bx-plus me-1"></i>Tambah Program Studi</a>
    </div>
</div>
<div class="row mt-3">
    <div class="col-12">
                    ...
                    <table id="table-utama" class="table table-sm table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('master.prodi.detail', ['id_prodi' => $value['id_prodi']]) }}" class="btn btn-info btn-sm m-1"><i class="bx bx-detail"></i></a>
                                    <a href="{{ route('master.prodi.edit', ['id_prodi' => $value['id_prodi']]) }}" class="btn btn-warning btn-sm m-1"><i class="bx bx-edit"></i></a>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content bg-white">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('master.prodi.proses-delete', ['id_prodi' => $value['id_prodi']]) }}" class="btn btn-danger">Hapus</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
