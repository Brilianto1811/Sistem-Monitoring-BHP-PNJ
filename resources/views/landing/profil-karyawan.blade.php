        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item" aria-current="page">
                    <a href="{{ route('karyawan.dashboard') }}">Pengguna</a>
                </li>
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mt-1">
                    <div class="col-12">
                        <a href="{{ route('karyawan.dashboard') }}" class="btn btn-secondary m-1 radius-30 px-5"><i class="bx bx-chevron-left me-1"></i>Kembali</a>
                    </div>
                </div>
                {{-- [END] ACTION FORM --}}
            </div>
