							...
							<div class="col-xl-6">
								<div class="card-body p-5">
									<div class="text-center">
										...
										<h3 class="mt-4 font-weight-bold">Login Mahasiswa</h3>
									...
									<div class="">
										<div class="form-body">
											<form class="row g-3" action="{{ route('mahasiswa.proses-login') }}" method="POST">
                                                @csrf
												<div class="col-12">
													<label for="inputEmailAddress" class="form-label">NIM</label>
													<input name="nim" type="text" class="form-control" id="inputEmailAddress" placeholder="Masukkan NIM">
												</div>
												<div class="col-12">
